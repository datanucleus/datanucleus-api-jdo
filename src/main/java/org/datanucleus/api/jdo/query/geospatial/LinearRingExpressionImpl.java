...
import javax.jdo.query.geospatial.LinearRingExpression;
 ...
 */
public class LinearRingExpressionImpl<T> extends GeometryExpressionImpl<T> implements LinearRingExpression<T>
{
    public LinearRingExpressionImpl(PersistableExpression parent, String name)
    {
        super(parent, name);
    }

    public LinearRingExpressionImpl(Expression queryExpr)
    {
        super(queryExpr);
    }
